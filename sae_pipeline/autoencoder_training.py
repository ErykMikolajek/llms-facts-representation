...
from common.utils import find_device, set_seed
...
def train_autoencoder_streaming(
    ...
    from sae_pipeline.activations_collecting import open_token_store, iter_activation_chunks

    store = open_token_store(
        data_path,
        seq_length,
