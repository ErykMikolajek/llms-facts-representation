...
NW ocenie na wydzielonym zbiorze testowym tekstów MoE zachowało znaczną część jakości modelowania języka względem modelu bazowego. Względny wzrost PPL wyniósł od $1{,}80\%$ do $5{,}89\%$ zależnie od domeny oraz około $0{,}39\%$ dla tekstów ogólnych. Wszystkie te wartości mieściły się w przyjętym limicie wzrostu PPL równym $10\%$. Nie uzyskano jednak poprawy względem modelu nieprzyciętego. Na benchmarku MoE średnia sparowana różnica NLL wyniosła $+0{,}0415$. Niższe NLL dla MoE wystąpiło w $32\%$ przykładów. Wynik wskazuje więc na niewielkie pogorszenie probabilistycznej oceny odpowiedzi. Rozkład efektów między domenami przedstawiono na rysunku~\ref{fig:walidacja_nll}. Największą regresję uzyskano dla matematyki, ze średnią różnicą $+0{,}1430$, oraz sportu, z różnicą $+0{,}0841$. Dla prawa i polityki średnie były nieznacznie ujemne.
...
Istotne jest rozróżnienie sposobów agregacji. Przy nadaniu jednakowej wagi każdemu przykładowi wszystkie domeny wnoszą taki sam udział do wyniku. Przy ważeniu tokenami odpowiedzi NLL wzrosło z $1{,}2027$ do $1{,}2271$, a odpowiadające mu PPL z $3{,}3292$ do $3{,}4113$, czyli o $2{,}47\%$. Tę drugą agregację zdominował Python, obejmujący $7483$ spośród $8257$ tokenów odpowiedzi. Nie należy zatem utożsamiać różnicy tokenowo ważonych średnich z przedstawioną na wykresie średnią różnic dla przykładów. Również bezwzględne NLL różnych domen nie są bezpośrednią miarą ich względnej trudności, ponieważ oceniane odpowiedzi mają różną długość i postać. \newline
Trafność odpowiedzi w pytaniach wyboru zmieniła się w znacznie mniejszym stopniu niż NLL. Wyniki zestawiono w tabeli~\ref{tab:walidacja_mc}. Łącznie liczba poprawnych odpowiedzi wzrosła ze $141$ do $143$ na $400$ pytań, czyli z $35{,}25\%$ do $35{,}75\%$. Dla biomedycyny trzy odpowiedzi zmieniły się z błędnych na poprawne, bez zmian w przeciwną stronę. Tak mała liczba zmian nie stanowi jednak dowodu poprawy kompetencji. W sporcie pogorszenie NLL nie zmieniło żadnej decyzji wyboru odpowiedzi.
