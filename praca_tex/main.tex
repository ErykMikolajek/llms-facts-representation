...
\input{chapters/1_wstep}

\input{chapters/2_wprowadzenie_teoretyczne.tex}

\input{chapters/3_srodowisko_eksperymentalne.tex}

\input{chapters/4_klasteryzacja_i_topografia_wag}

\input{chapters/5_pruning_i_budowa_architektury_moe}

\input{chapters/6_walidacja_i_wizualizacja}

\input{chapters/7_zakonczenie}
...
\appendix
\input{appendices/A_katalog_cech_pythia}
